...
class DataHandler:
	...
	def __init__(self, courseGradePath, fromIndex, toIndex, minGrade):
		self.__loadData(courseGradePath, fromIndex, toIndex, minGrade)

	def __loadData(self, courseGradePath, fromIndex, toIndex):

		# with open(courseGradePath, "r") as fp:
		...
		ref = openpyxl.load_workbook(courseGradePath)
		sheet = ref.active
		self.dataArray = sheet[fromIndex: toIndex]
